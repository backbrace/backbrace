ace.define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function(acerequire, exports, module) {
    "use strict";
    ...
    acerequire("./lib/dom").importCssString("\
    .ace_snippet-marker {\
...
ace.define("ace/autocomplete/text_completer", ["require", "exports", "module", "ace/range"], function(acerequire, exports, module) {
    var Range = acerequire("../range").Range;
...
ace.define("ace/autocomplete/popup", ["require", "exports", "module", "ace/virtual_renderer", "ace/editor", "ace/range", "ace/lib/event", "ace/lib/lang", "ace/lib/dom"], function(acerequire, exports, module) {
    "use strict";
...
ace.define("ace/autocomplete/util", ["require", "exports", "module"], function(acerequire, exports, module) {
    "use strict";
...
ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/snippets"], function(acerequire, exports, module) {
    "use strict";

    var HashHandler = acerequire("./keyboard/hash_handler").HashHandler;
    var AcePopup = acerequire("./autocomplete/popup").AcePopup;
    var util = acerequire("./autocomplete/util");
    var event = acerequire("./lib/event");
    var lang = acerequire("./lib/lang");
    var dom = acerequire("./lib/dom");
    var snippetManager = acerequire("./snippets").snippetManager;
...
ace.define("ace/tern/tern_server", ["require", "exports", "module", "ace/range", "ace/lib/dom"], function(acerequire, exports, module) {
    ...
    function applyChanges(ts, changes, cb) {
        var Range = ace.acequire("ace/range").Range; //for ace
    ...
    var dom = acerequire("ace/lib/dom");
...
ace.define("ace/tern/tern", ["require", "exports", "module", "ace/config", "ace/lib/lang", "ace/snippets", "ace/autocomplete/text_completer", "ace/autocomplete", "ace/tern/tern_server", "ace/editor"], function(acerequire, exports, module) {
    "use strict";
    ...
    var textCompleter = acerequire("../autocomplete/text_completer");
    ...
    var Autocomplete = acerequire("../autocomplete").Autocomplete;
    Autocomplete.startCommand = {
        name: "startAutocomplete",
    ...
    var TernServer = acerequire("./tern_server").TernServer;
    var aceTs;
